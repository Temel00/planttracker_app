...
import 'package:planttracker_app/services/auth/auth_provider.dart';
import 'package:planttracker_app/services/auth/auth_user.dart';
...
void main() {
  group('Mock Authentication', () {
    ...
    test('Provider should start uninitialized', () {
    ...
    test('Provider can be initialized', () async {
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({
    ...
    const user =
        AuthUser(id: 'myd', isEmailVerified: false, email: 'foo@bar.com');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser =
        AuthUser(id: 'myd', isEmailVerified: true, email: 'foo@bar.com');
    _user = newUser;
  }
}
